...
$data = $this->data;
$link = JRoute::_( "index.php?option=com_b4&view=price&id={$data->id}" );
?>
<div>
	...
	<div class="jcb_fieldDiv">
		<span class="jcb_fieldLabel"><?php echo JText::_( 'PRICE' ); ?></span>
		<span class="jcb_fieldValue"><?php echo $data->price; ?></span>
	</div>
	<div class="jcb_fieldDiv">
	...
	<div class="jcb_fieldDiv">
		<span class="jcb_fieldLabel"><?php echo JText::_( 'DATE_ADD' ); ?></span>
		<span class="jcb_fieldValue"><?php echo $data->date_add; ?></span>
	</div>
