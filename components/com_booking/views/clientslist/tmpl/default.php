...
<!-- Joomla! Component Builder - begin code  -->
	<th class="jcb_fieldDiv jcb_fieldLabel">
		<?php echo JText::_( '_CLIENTS_ID' ); ?>
	</th>
	<th class="jcb_fieldDiv jcb_fieldLabel">
		<?php echo JText::_( '_CLIENTS_ROOMS_ID' ); ?>
	</th>
	<th class="jcb_fieldDiv jcb_fieldLabel">
		<?php echo JText::_( '_CLIENTS_NAME' ); ?>
	</th>
	<th class="jcb_fieldDiv jcb_fieldLabel">
		<?php echo JText::_( '_CLIENTS_DATE1' ); ?>
	</th>
	<th class="jcb_fieldDiv jcb_fieldLabel">
		<?php echo JText::_( '_CLIENTS_DATE2' ); ?>
	</th>
	<th class="jcb_fieldDiv jcb_fieldLabel">
		<?php echo JText::_( '_CLIENTS_PUBLISHED' ); ?>
	</th>
...
<?php
	$link = JRoute::_( "index.php?option=com_booking&view=clients&id={$dataItem->id}" );
?>
		<tr>
			<td>
